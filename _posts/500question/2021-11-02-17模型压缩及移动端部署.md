...
![](https://limu111.github.io/img/ch17/剪枝粒度分类.png)
...
![](https://limu111.github.io/img/ch17/网络蒸馏.png)
...
![](https://limu111.github.io/img/ch17/tensorRT1.png)

![](https://limu111.github.io/img/ch17/tensorRT2.png)

![](https://limu111.github.io/img/ch17/tensorRT3.png)
...
传统卷积计算方式如下：  
![image](https://limu111.github.io/img/ch17/1.png)
传统卷积运算量为：  
$$
A = H*W * h1 * w1 * c1 * c2
$$
...
![image](https://limu111.github.io/img/ch17/2.png)
...
传统卷积计算方式如下：  
![image](https://limu111.github.io/img/ch17/3.png)
传统卷积运算量为：  
$$
A = H * W * h1 * w1 * c1 * c2
$$
DW卷积的计算方式如下：  
![image](https://limu111.github.io/img/ch17/4.png)
DW卷积运算量为： 
$$
B_DW = H * W * h1 * w1 * 1 * c1
$$
PW卷积的计算方式如下：
![image](https://limu111.github.io/img/ch17/5.png)
...
![image](https://limu111.github.io/img/ch17/6.png)
实验中使用的基本网络结构，分别将它们重复10次，然后进行实验。实验结果如下：
![image](https://limu111.github.io/img/ch17/7.png)
...
![image](https://limu111.github.io/img/ch17/8.png)
...
![image](https://limu111.github.io/img/ch17/9.png)
SqueezeNet整体网络结构如下图所示：
![image](https://limu111.github.io/img/ch17/10.png)

#### 1.3实验结果
不同压缩方法在ImageNet上的对比实验结果
![image](https://limu111.github.io/img/ch17/11.png)
...
![image](https://limu111.github.io/img/ch17/12.png)
深度可分离卷积与传统卷积运算量对比：
![image](https://limu111.github.io/img/ch17/13.png)
网络结构：
![image](https://limu111.github.io/img/ch17/14.png)

* MobileNets的架构
![image](https://limu111.github.io/img/ch17/15.png)

#### 2.3 实验结果
![image](https://limu111.github.io/img/ch17/16.png)
...
![image](https://limu111.github.io/img/ch17/17.png)
*  Linear bottlenecks  
ReLu激活函数会破坏特征。ReLu对于负的输入，输出全为0，而本来DW conv特征通道已经被“压缩”，再经过ReLu的话，又会损失一部分特征。采用Linear，目的是防止Relu破坏特征。
![image](https://limu111.github.io/img/ch17/18.png)
* shortcut  
stride=2的conv不使用shot-cot，stride=1的conv使用shot-cut
![image](https://limu111.github.io/img/ch17/19.png)
* 网络架构  
![image](https://limu111.github.io/img/ch17/20.png)
...
![image](https://limu111.github.io/img/ch17/21.png)
...
![image](https://limu111.github.io/img/ch17/26.png)
网络结构  
![image](https://limu111.github.io/img/ch17/27.png)
...
![](https://limu111.github.io/img/ch17/QNNPACK1.jpeg)
...
![](https://limu111.github.io/img/ch17/QNNPACK2.jpeg)
...
![](https://limu111.github.io/img/ch17/QNNPACK3.jpeg)
...
![](https://limu111.github.io/img/ch17/QNNPACK4.jpeg)
...
![](https://limu111.github.io/img/ch17/mv1.jpg)
...
![](https://limu111.github.io/img/ch17/mv2.jpg)
...
![](https://limu111.github.io/img/ch17/mv3.jpg)
...
![](https://limu111.github.io/img/ch17/MDL1.png)
...
![](https://limu111.github.io/img/ch17/mace-arch.png)
...
![](https://limu111.github.io/img/ch17/mace-work-flow-zh.png)
...
![](https://limu111.github.io/img/ch17/maca_com.jpg)
...
![](https://limu111.github.io/img/ch17/tflite_artc.JPEG)
...
![](https://limu111.github.io/img/ch17/framework_design.png)
...
- f) 超参数优化（hyper-parameter optimization）组件：多数开发者对模型压缩算法往往不甚了解，但超参数取值对最终结果往往有着巨大的影响，因此团队引入了超参数优化组件，采用了包括强化学习等算法以及  AI Lab 自研的 AutoML  自动超参数优化框架来根据具体性能需求，确定最优超参数取值组合。例如，对于通道剪枝算法，超参数优化组件可以自动地根据原始模型中各层的冗余程度，对各层采用不同的剪枝比例，在保证满足模型整体压缩倍数的前提下，实现压缩后模型识别精度的最大化。
  ...
  ![](https://limu111.github.io/img/ch17/packflow1.jpg)
...
![](https://limu111.github.io/img/ch17/packflow2.jpg)

![](https://limu111.github.io/img/ch17/packflow3.jpg)
...
![](https://limu111.github.io/img/ch17/packflow4.jpg)

![](https://limu111.github.io/img/ch17/packflow5.jpg)
