...
![E值](https://limu111.github.io/img/ch18/18-9-3-1.png)
...
- **AP和mAP(mean Average Precision)** 
  ...
  ![](https://limu111.github.io/img/ch18/18-6-3-2.jpg)
  ...
  ![](https://limu111.github.io/img/ch18/18-6-3-3.jpg)

- **ROC和AUC** 

  ​	ROC和AUC是评价分类器的指标，上面第一个图的ABCD仍然使用，只是需要稍微变换。 

  ![](https://limu111.github.io/img/ch18/18-6-3-4.jpg)
  ...
  ![](https://limu111.github.io/img/ch18/18-6-3-5.jpg)
...
![](https://limu111.github.io/img/ch18/18-6-4-3.png)

​	通过这两步，我们可以从非常庞大的视频库中选择视频，并面向用户进行有针对性的推荐。这个方法还能让我们把其他来源的内容也容纳进来。 

![](https://limu111.github.io/img/ch18/18-6-4-4.png)
